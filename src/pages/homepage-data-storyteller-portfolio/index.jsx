            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link to="/about-professional-journey" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200">
                      About Me
                    </Link>
                  </li>
                  <li>
                    <Link to="/project-case-studies-portfolio" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200">
                      Projects
                    </Link>
                  </li>
                  <li>
                    <Link to="/skills-interactive-capabilities" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200">
                      Skills
                    </Link>
                  </li>
                  <li>
                    <Link to="/insights-professional-blog" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors duration-200">
                      Blog
                    </Link>
                  </li>
                </ul>
